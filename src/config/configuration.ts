export default () => ({
  ...
  // mongoCluster: `mongodb+srv://${process.env.DB_USERNAME}:${process.env.DB_PASSWORD}@localhost:${process.env.DB_PORT}/${process.env.DB_NAME}?authSource=${process.env.AUTH_SOURCE}`,
  mongoCluster: `mongodb+srv://${process.env.DB_USERNAME}:${process.env.DB_PASSWORD}@cluster0.iiseuxv.mongodb.net/${process.env.DB_NAME}?retryWrites=true&w=majority`,
